...
/**
 * An idealized spark-ignition passenger car with everything a well-equipped
 * gasoline car can report: VW-coded VIN (model year 2011), one ECU on CAN
 * 11/500, catalyst/EVAP/O2/O2-heater/EGR monitors with EVAP still
 * incomplete. Internal: the base of the hybrid profile and the broad PID
 * set the test-suite exercises. The public default gasoline vehicle is the
 * recorded one (./gasoline).
 */
export const SYNTHETIC_GASOLINE_PROFILE: VehicleProfile = {
    name: 'synthetic-gasoline',
